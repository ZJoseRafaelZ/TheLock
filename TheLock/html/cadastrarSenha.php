...
<head>
    ...
    <link rel="stylesheet" href="../css/cadastrarSenha.css">
...
<body>
    ...
    <section class="container">
        ...
        <div id="formulario">
            ...
            <form action="../php/cadastrarSenha.php" method="POST" >
                <div class="input-container">
                    <input type="text" id="nomeplataforma" name="nomeplataforma" class="text-input" placeholder="Nome da Plataforma" autocomplete="off" required/>
                ...
                <div class="input-container">
                    <input type="text" id="email" name="email" class="text-input" placeholder="Login" autocomplete="off" required/>
                ...
                <input class="btCadastrar" id="submit" type="submit" name="submit" value="Cadastrar" href="main.php">
